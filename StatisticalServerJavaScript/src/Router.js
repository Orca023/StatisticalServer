...
// ){
    ...
    switch (request_url_path) {
        ...
        case "/Interpolation": {
            ...
            // Pdata_0 = [
            //     math.mean(math.mean(YdataMean.map(function(value, index, self) { let newItem = ((YdataMean[index] % (math.mean(YdataMean.map(function(value, index, self) { let newItem = parseFloat(YdataMean[index] / Xdata[index] ** 1); return newItem; })) * Xdata[index] ** 1)) * (math.mean(YdataMean.map(function(value, index, self) { let newItem = parseFloat(YdataMean[index] / Xdata[index] ** 1); return newItem; })) * Xdata[index] ** 1)); return newItem; }).filter(function(value, index, self) { if ((index === self.findIndex((item, index, self) => { if (item === math.min(self)) { return true; } else { return false; }; })) || (index === self.findIndex((item, index, self) => { if (item === math.max(self)) { return true; } else { return false; }; }))) { return false; } else { return true; }; })) + math.mean(YdataMean.map(function(value, index, self) { let newItem = ((YdataMean[index] % (math.mean(YdataMean.map(function(value, index, self) { let newItem = parseFloat(YdataMean[index] / Xdata[index] ** 2); return newItem; })) * Xdata[index] ** 2)) * (math.mean(YdataMean.map(function(value, index, self) { let newItem = parseFloat(YdataMean[index] / Xdata[index] ** 2); return newItem; })) * Xdata[index] ** 2)); return newItem; }).filter(function(value, index, self) { if ((index === self.findIndex((item, index, self) => { if (item === math.min(self)) { return true; } else { return false; }; })) || (index === self.findIndex((item, index, self) => { if (item === math.max(self)) { return true; } else { return false; }; }))) { return false; } else { return true; }; })) + math.mean(YdataMean.map(function(value, index, self) { let newItem = ((YdataMean[index] % (math.mean(YdataMean.map(function(value, index, self) { let newItem = parseFloat(YdataMean[index] / Xdata[index] ** 3); return newItem; })) * Xdata[index] ** 3)) * (math.mean(YdataMean.map(function(value, index, self) { let newItem = parseFloat(YdataMean[index] / Xdata[index] ** 3); return newItem; })) * Xdata[index] ** 3)); return newItem; }).filter(function(value, index, self) { if ((index === self.findIndex((item, index, self) => { if (item === math.min(self)) { return true; } else { return false; }; })) || (index === self.findIndex((item, index, self) => { if (item === math.max(self)) { return true; } else { return false; }; }))) { return false; } else { return true; }; }))),
            //     math.mean(Array.from({ length: parseInt(YdataMean.length) }, function(_, index) { return index; }).map(function(value, index, self) { let newItem = parseFloat(YdataMean[value] / Xdata[value] ** 1); return newItem; }).filter(function(value, index, self) { if ((index === self.findIndex((item, index, self) => { if (item === math.min(self)) { return true; } else { return false; }; })) || (index === self.findIndex((item, index, self) => { if (item === math.max(self)) { return true; } else { return false; }; }))) { return false; } else { return true; }; })),
            //     math.mean(Array.from({ length: parseInt(YdataMean.length) }, function(_, index) { return index; }).map(function(value, index, self) { let newItem = parseFloat(YdataMean[value] / Xdata[value] ** 2); return newItem; }).filter(function(value, index, self) { if ((index === self.findIndex((item, index, self) => { if (item === math.min(self)) { return true; } else { return false; }; })) || (index === self.findIndex((item, index, self) => { if (item === math.max(self)) { return true; } else { return false; }; }))) { return false; } else { return true; }; })),
            //     math.mean(Array.from({ length: parseInt(YdataMean.length) }, function(_, index) { return index; }).map(function(value, index, self) { let newItem = parseFloat(YdataMean[value] / Xdata[value] ** 3); return newItem; }).filter(function(value, index, self) { if ((index === self.findIndex((item, index, self) => { if (item === math.min(self)) { return true; } else { return false; }; })) || (index === self.findIndex((item, index, self) => { if (item === math.max(self)) { return true; } else { return false; }; }))) { return false; } else { return true; }; }))
            // ];
            if (request_POST_JSON.hasOwnProperty("Pdata_0")) {
                if (request_POST_JSON["Pdata_0"].length > 0) {
                    ...
                    for (let i = 0; i < request_POST_JSON["Pdata_0"].length; i++) {
                        ...
                        } else if (Object.prototype.toString.call(request_POST_JSON["Pdata_0"][i]).toLowerCase() === '[object string]' && (request_POST_JSON["Pdata_0"][i] === "+Base.Inf" || request_POST_JSON["Pdata_0"][i] === "+Inf" || request_POST_JSON["Pdata_0"][i] === "+inf" || request_POST_JSON["Pdata_0"][i] === "+Infinity" || request_POST_JSON["Pdata_0"][i] === "+infinity" || request_POST_JSON["Pdata_0"][i] === "Base.Inf" || request_POST_JSON["Pdata_0"][i] === "Inf" || request_POST_JSON["Pdata_0"][i] === "inf" || request_POST_JSON["Pdata_0"][i] === "Infinity" || request_POST_JSON["Pdata_0"][i] === "infinity")) {
                            Pdata_0.push(+Infinity);
                        } else if (Object.prototype.toString.call(request_POST_JSON["Pdata_0"][i]).toLowerCase() === '[object string]' && (request_POST_JSON["Pdata_0"][i] === "-Base.Inf" || request_POST_JSON["Pdata_0"][i] === "-Inf" || request_POST_JSON["Pdata_0"][i] === "-inf" || request_POST_JSON["Pdata_0"][i] === "-Infinity" || request_POST_JSON["Pdata_0"][i] === "-infinity")) {
                            Pdata_0.push(-Infinity);
                        } else {
            ...
            // let weight = new Array(parseInt(request_POST_JSON['trainYdata'].length)).fill(parseFloat(1.0));
            // // 使用高斯核賦權法;
            ...
            // if ((parseInt(target) >= parseInt(1)) && (parseInt(target) <= parseInt(request_POST_JSON['trainYdata'].length))) {
            //     for (let i = 0; i < request_POST_JSON['trainYdata'].length; i++) {
            //         let wei = parseFloat(1.0);
            //         if ((Object.prototype.toString.call(request_POST_JSON['trainYdata'][i]).toLowerCase() === '[object number]') && (Object.prototype.toString.call(request_POST_JSON['trainYdata'][parseInt(parseInt(target) - parseInt(1))]).toLowerCase() === '[object number]')) {
            //             if (parseFloat(request_POST_JSON['trainYdata'][parseInt(parseInt(target) - parseInt(1))]) === parseFloat(0.0)) {
            //                 wei = parseFloat(1.0);
            //             } else {
            //                 // math.exp((request_POST_JSON['trainYdata'][i] / request_POST_JSON['trainYdata'][parseInt(parseInt(target) - parseInt(1))] - 1)**2 / ((-2) * af**2));
            //                 // math.pow(math.e, ((request_POST_JSON['trainYdata'][i] / request_POST_JSON['trainYdata'][parseInt(parseInt(target) - parseInt(1))] - 1)**2 / ((-2) * af**2)));
            //                 wei = parseFloat(math.exp(parseFloat(parseInt(-1) * parseFloat(parseFloat(parseFloat(parseFloat(parseFloat(request_POST_JSON['trainYdata'][i]) / parseFloat(request_POST_JSON['trainYdata'][parseInt(parseInt(target) - parseInt(1))])) - parseInt(1)) ** parseInt(2)) / parseFloat(parseInt(2) * parseFloat(parseFloat(af) ** parseInt(2)))))));
            //             };
            //         };
            //         weight[i] = wei;
            //         // weight.push(wei);
            ...
            if (request_POST_JSON.hasOwnProperty("weight")) {
                if (request_POST_JSON["weight"].length > 0) {
                    ...
                    for (let i = 0; i < request_POST_JSON["weight"].length; i++) {
                        ...
                        } else if (Object.prototype.toString.call(request_POST_JSON["weight"][i]).toLowerCase() === '[object string]' && (request_POST_JSON["weight"][i] === "+Base.Inf" || request_POST_JSON["weight"][i] === "+Inf" || request_POST_JSON["weight"][i] === "+inf" || request_POST_JSON["weight"][i] === "+Infinity" || request_POST_JSON["weight"][i] === "+infinity" || request_POST_JSON["weight"][i] === "Base.Inf" || request_POST_JSON["weight"][i] === "Inf" || request_POST_JSON["weight"][i] === "inf" || request_POST_JSON["weight"][i] === "Infinity" || request_POST_JSON["weight"][i] === "infinity")) {
                            weight.push(+Infinity);
                        } else if (Object.prototype.toString.call(request_POST_JSON["weight"][i]).toLowerCase() === '[object string]' && (request_POST_JSON["weight"][i] === "-Base.Inf" || request_POST_JSON["weight"][i] === "-Inf" || request_POST_JSON["weight"][i] === "-inf" || request_POST_JSON["weight"][i] === "-Infinity" || request_POST_JSON["weight"][i] === "-infinity")) {
                            weight.push(-Infinity);
                        } else {
            ...
            if (typeof (request_POST_JSON) === 'object' && Object.prototype.toString.call(request_POST_JSON).toLowerCase() === '[object object]' && !(request_POST_JSON.length) && JSON.stringify(request_POST_JSON) !== '{}') {
                ...
                //     {"Xdata": request_POST_JSON['trainXdata'], "Ydata": request_POST_JSON['trainYdata']},  // training_data;
                //     {"Xdata": request_POST_JSON['testXdata'], "Ydata": request_POST_JSON['testYdata']},  // testing_data;
                //     {
                //         "Pdata_0": Pdata_0,
                //         "Plower": Plower,
                //         "Pupper": Pupper,
