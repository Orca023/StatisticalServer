...
function do_Request(request_Dict::Base.Dict{Core.String, Core.Any})::Core.String
    ...
    elseif request_Path === "/KLineCleaning"
        ...
        if Base.length(stdout_Command) > 0
            if Base.occursin("\n", stdout_Command)
                for x in Base.split(stdout_Command, "\n")
                    # print(x * "\n");
                ...
                Base.push!(backArray, stdout_Command);
            end
        end
        # println(backArray);
        ...
        # stepping_data = Quantitative_Data_Cleaning.stepping_data;
        # stepping_data = JSONparse(stdout_Command);  # 使用自定義函數 JSONparse() 將函數返回值的 JSON 字符串類型轉換為 Julia 字典（Dict）對象;
    ...
    elseif request_Path === "/PickStock"
        # 客戶端或瀏覽器請求 url = http://[::1]:10001/PickStock?Key=username:password&algorithmUser=username&algorithmPass=password&algorithmName=PickStock&trading_direction=Long_Position_and_Short_Selling&ticker_symbol=["all"]&is_Optimize=false&PickStock_Pdata_0=[3,5]&PickStock_Plower=["-Infinity","-Infinity"]&PickStock_Pupper=["+Infinity","+Infinity"]&PickStock_weight=[]&MarketTiming_Pdata_0=[3,+0.1,-0.1,0.0]&MarketTiming_Plower=["-Infinity","-Infinity","-Infinity","-Infinity"]&MarketTiming_Pupper=["+Infinity","+Infinity","+Infinity","+Infinity"]&MarketTiming_weight=[]&Cleaned_K_Line=C:/StatisticalServer/Data/steppingData.jld&training_data_file=C:/StatisticalServer/Data/trainingData.jld&testing_data_file=C:/StatisticalServer/Data/testingData.jld
        # 客戶端或瀏覽器請求 url = http://127.0.0.1:10001/PickStock?Key=username:password&algorithmUser=username&algorithmPass=password&algorithmName=PickStock&trading_direction=Long_Position_and_Short_Selling&ticker_symbol=["all"]&is_Optimize=false&PickStock_Pdata_0=[3,5]&PickStock_Plower=["-Infinity","-Infinity"]&PickStock_Pupper=["+Infinity","+Infinity"]&PickStock_weight=[]&MarketTiming_Pdata_0=[3,+0.1,-0.1,0.0]&MarketTiming_Plower=["-Infinity","-Infinity","-Infinity","-Infinity"]&MarketTiming_Pupper=["+Infinity","+Infinity","+Infinity","+Infinity"]&MarketTiming_weight=[]&Cleaned_K_Line=C:/StatisticalServer/Data/steppingData.jld&training_data_file=C:/StatisticalServer/Data/trainingData.jld&testing_data_file=C:/StatisticalServer/Data/testingData.jld
