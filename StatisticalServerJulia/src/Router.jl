...
function do_Request(request_Dict::Base.Dict{Core.String, Core.Any})::Core.String
    ...
    elseif request_Path === "/PickStock"
        ...
        if is_Optimize === false
            ...
            response_body_Dict["return_PickStock"]["Coefficient"] = PickStock_Pdata_0;
        ...
        elseif is_Optimize === true
            ...
            return_PickStock = PickStock(
                ...
                Pdata_0 = PickStock_Pdata_0,  # [Core.Int64(3), Core.Int64(5)],  #training_data["002611"]["Pdata_0"],
                # weight = PickStock_weight,  # Core.Array{Core.Float64, 1}(),  # training_data["002611"]["weight"],
                Plower = PickStock_Plower,  # [-Base.Inf, -Base.Inf],  # training_data["002611"]["Plower"],
                Pupper = PickStock_Pupper,  # [+Base.Inf, +Base.Inf],  # training_data["002611"]["Pupper"],
            ...
            response_body_Dict["return_PickStock"]["Coefficient"] = return_PickStock["Coefficient"];
