        ...
        If Len(Len_inputDataNameArray) > 0 Then
            ...
            If Len(Len_inputDataArray) > 0 Then
                ...
                For j = LBound(inputDataArray, 2) To UBound(inputDataArray, 2)
                    ...
                    If (CStr(inputDataNameArray(j)) = "configFile") Or (CStr(inputDataNameArray(j)) = "input_K_Line") Or (CStr(inputDataNameArray(j)) = "is_save_JLD") Or (CStr(inputDataNameArray(j)) = "output_jld_K_Line") Or (CStr(inputDataNameArray(j)) = "is_save_pickle") Or (CStr(inputDataNameArray(j)) = "output_pickle_K_Line") Or (CStr(inputDataNameArray(j)) = "is_save_csv") Or (CStr(inputDataNameArray(j)) = "output_csv_K_Line") Or (CStr(inputDataNameArray(j)) = "is_save_xlsx") Or (CStr(inputDataNameArray(j)) = "output_xlsx_K_Line") Or (CStr(inputDataNameArray(j)) = "Cleaned_K_Line") Or (CStr(inputDataNameArray(j)) = "trading_direction") Or (CStr(inputDataNameArray(j)) = "ticker_symbol") Or _
                    (CStr(inputDataNameArray(j)) = "is_Optimize") Or (CStr(inputDataNameArray(j)) = "MarketTiming_Pdata_0") Or (CStr(inputDataNameArray(j)) = "MarketTiming_Plower") Or (CStr(inputDataNameArray(j)) = "MarketTiming_Pupper") Or (CStr(inputDataNameArray(j)) = "MarketTiming_weight") Or (CStr(inputDataNameArray(j)) = "PickStock_Pdata_0") Or (CStr(inputDataNameArray(j)) = "PickStock_Plower") Or (CStr(inputDataNameArray(j)) = "PickStock_Pupper") Or (CStr(inputDataNameArray(j)) = "PickStock_weight") Or (CStr(inputDataNameArray(j)) = "SizePosition_Pdata_0") Or (CStr(inputDataNameArray(j)) = "SizePosition_Plower") Or (CStr(inputDataNameArray(j)) = "SizePosition_Pupper") Or (CStr(inputDataNameArray(j)) = "SizePosition_weight") Or (CStr(inputDataNameArray(j)) = "training_data_file") Or (CStr(inputDataNameArray(j)) = "testing_data_file") Or (CStr(inputDataNameArray(j)) = "stepping_data_file") Then
