VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} StatisticsAlgorithmControlPanel 
   Caption         =   "Statistics algorithm control panel"
   ClientHeight    =   8172
   ClientLeft      =   108
   ClientTop       =   456
   ClientWidth     =   11388
   OleObjectBlob   =   "StatisticsAlgorithmControlPanel.frx":0000
   StartUpPosition =   1  '所有者中心
End
Attribute VB_Name = "StatisticsAlgorithmControlPanel"
...
'窗體打開前事件，給窗體控件中的全局變量賦初值，函數 UserForm_Initialize 的作用是窗體控件打開即運行初始化
    ...
    StatisticsAlgorithmControlPanel.PublicCurrentWorkbookName = ThisWorkbook.name: Rem 獲得當前工作簿的名稱，效果等同於“ = ActiveWorkbook.Name ”
    StatisticsAlgorithmControlPanel.PublicCurrentWorkbookFullName = ThisWorkbook.FullName: Rem 獲得當前工作簿的全名（工作簿路徑和名稱）
    StatisticsAlgorithmControlPanel.PublicCurrentSheetName = ActiveSheet.name: Rem 獲得當前工作表的名稱
    ...
    '給當前變量賦初值初始化
    Public_Statistics_Algorithm_module_name = "": Rem 導入的統計算法模塊的自定義命名值字符串（當前所處的模塊名），例如：StatisticsAlgorithmModule

    Public_Statistics_Algorithm_Name = "": Rem 表示判斷選擇使用的辨識統計算法種類，可以取值：("test", "Interpolate", "Logistic", "Cox", "Polynomial3Fit", "LC5PFit") 等自定義的算法名稱值字符串。函數 CStr() 表示轉換爲字符串類型，例如取值：CStr(2)
    '判斷子框架控件是否存在
    If Not (StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame") Is Nothing) Then
        '遍歷框架中包含的子元素。
        Dim element_i
        For Each element_i In Statistics_Algorithm_Frame.Controls
            '判斷單選框控件的選中狀態
        ...
        'If StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Interpolate_OptionButton").Value Then
        '    Public_Statistics_Algorithm_Name = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Interpolate_OptionButton").Caption)
        'End If
        'If StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Logistic_OptionButton").Value Then
        '    Public_Statistics_Algorithm_Name = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Logistic_OptionButton").Caption)
        'End If
        'If StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Cox_OptionButton").Value Then
        '    Public_Statistics_Algorithm_Name = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Cox_OptionButton").Caption)
        'End If
        'If StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Polynomial3_OptionButton").Value Then
        '    Public_Statistics_Algorithm_Name = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Polynomial3_OptionButton").Caption)
        'End If
        'If StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("LC5p_OptionButton").Value Then
        '    Public_Statistics_Algorithm_Name = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("LC5p_OptionButton").Caption)
        'End If
        'If StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("PCA_OptionButton").Value Then
        '    Public_Statistics_Algorithm_Name = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("PCA_OptionButton").Caption)
        'End If
        'If StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Factor_OptionButton").Value Then
        '    Public_Statistics_Algorithm_Name = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Factor_OptionButton").Caption)
        'End If
        'If StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("TimeSeries_OptionButton").Value Then
        '    Public_Statistics_Algorithm_Name = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("TimeSeries_OptionButton").Caption)
        'End If
        'If StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("FisherDiscriminant_OptionButton").Value Then
        '    Public_Statistics_Algorithm_Name = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("FisherDiscriminant_OptionButton").Caption): Rem 從單選框張提取值，結果為字符串型。函數 CStr() 表示轉換爲字符串類型。
        'End If
        'If StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Meta_OptionButton").Value Then
        '    Public_Statistics_Algorithm_Name = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Meta_OptionButton").Caption)
        'End If
        'If StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Optimal_run_length_estimate_OptionButton").Value Then
        '    Public_Statistics_Algorithm_Name = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Optimal_run_length_estimate_OptionButton").Caption)
        'End If
        'If StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Test_accuracy_estimate_OptionButton").Value Then
        '    Public_Statistics_Algorithm_Name = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Test_accuracy_estimate_OptionButton").Caption)
        'End If
        'If StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Test_power_estimate_OptionButton").Value Then
        '    Public_Statistics_Algorithm_Name = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Test_power_estimate_OptionButton").Caption)
        'End If
        'If StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Statistical_sampling_OptionButton").Value Then
        '    Public_Statistics_Algorithm_Name = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Statistical_sampling_OptionButton").Caption)
        'End If
    End If
    ...
    '    'Public_Database_Server_Url = CStr(StatisticsAlgorithmControlPanel.Controls("Database_Server_Url_TextBox").Value): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    '    Public_Database_Server_Url = CStr(StatisticsAlgorithmControlPanel.Controls("Database_Server_Url_TextBox").Text): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    'End If
    ...
    '    'Public_Statistics_Algorithm_Server_Url = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Server_Url_TextBox").Value): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    '    Public_Statistics_Algorithm_Server_Url = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Server_Url_TextBox").Text): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    'End If
    ...
    '    'Public_Statistics_Algorithm_Server_Username = CStr(StatisticsAlgorithmControlPanel.Controls("Username_TextBox").Value): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    '    Public_Statistics_Algorithm_Server_Username = CStr(StatisticsAlgorithmControlPanel.Controls("Username_TextBox").Text): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    'End If
    ...
    '    'Public_Statistics_Algorithm_Server_Password = CStr(StatisticsAlgorithmControlPanel.Controls("Password_TextBox").Value): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    '    Public_Statistics_Algorithm_Server_Password = CStr(StatisticsAlgorithmControlPanel.Controls("Password_TextBox").Text): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    'End If
    ...
    '    If CStr(StatisticsAlgorithmControlPanel.Controls("Delay_input_TextBox").Text) = CStr("") Then
    ...
    '    If CStr(StatisticsAlgorithmControlPanel.Controls("Delay_random_input_TextBox").Text) = CStr("") Then
    ...
    '    'Public Public_Data_name_input_position = CStr(StatisticsAlgorithmControlPanel.Controls("Field_name_of_Data_Input_TextBox").Value): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    '    Public Public_Data_name_input_position = CStr(StatisticsAlgorithmControlPanel.Controls("Field_name_of_Data_Input_TextBox").Text): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    'End If
    ...
    '    'Public_Data_input_position = CStr(StatisticsAlgorithmControlPanel.Controls("Data_TextBox").Value): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    '    Public_Data_input_position = CStr(StatisticsAlgorithmControlPanel.Controls("Data_TextBox").Text): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    'End If
    ...
    '    'Public_Result_output_position = CStr(StatisticsAlgorithmControlPanel.Controls("Output_position_TextBox").Value): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    '    Public_Result_output_position = CStr(StatisticsAlgorithmControlPanel.Controls("Output_position_TextBox").Text): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    'End If


    'Public_First_level_page_number_source_xpath = "": Rem 定位“當前第一層級頁面中頁碼信息源元素”的 XPath 值字符串
    'If Not (StatisticsAlgorithmControlPanel.Controls("First_level_page_number_source_xpath_TextBox") Is Nothing) Then
    '    'Public_First_level_page_number_source_xpath = CStr(StatisticsAlgorithmControlPanel.Controls("First_level_page_number_source_xpath_TextBox").Value): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    '    Public_First_level_page_number_source_xpath = CStr(StatisticsAlgorithmControlPanel.Controls("First_level_page_number_source_xpath_TextBox").Text): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    ...
    ''If Not (StatisticsAlgorithmControlPanel.Controls("Inject_data_page_JavaScript_TextBox") Is Nothing) Then
    ''    'Public_Inject_data_page_JavaScript = CStr(StatisticsAlgorithmControlPanel.Controls("Inject_data_page_JavaScript_TextBox").Value): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    ''    Public_Inject_data_page_JavaScript = CStr(StatisticsAlgorithmControlPanel.Controls("Inject_data_page_JavaScript_TextBox").Text): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    ''End If
    ...
    'If Not (StatisticsAlgorithmControlPanel.Controls("Inject_data_page_JavaScript_TextBox") Is Nothing) Then
    '    'Public_Inject_data_page_JavaScript_filePath = CStr(StatisticsAlgorithmControlPanel.Controls("Inject_data_page_JavaScript_TextBox").Value): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
    '    Public_Inject_data_page_JavaScript_filePath = CStr(StatisticsAlgorithmControlPanel.Controls("Inject_data_page_JavaScript_TextBox").Text): Rem 從文本輸入框控件中提取值，結果為字符串型。函數 CStr() 表示强制轉換為字符串型
...
Private Sub Delay_input_TextBox_Change()
    ...
    If Not (StatisticsAlgorithmControlPanel.Controls("Delay_input_TextBox") Is Nothing) Then
        ...
        Else
            ...
            StatisticsAlgorithmModule.Public_Delay_length_input = Public_Delay_length_input
            'StatisticsAlgorithmModule.Public_Delay_length_input = CLng(StatisticsAlgorithmControlPanel.Controls("Delay_input_TextBox").Text): Rem 為導入的爬蟲策略模塊 StatisticsAlgorithmModule 中包含的（人爲延時等待時長基礎值，單位毫秒，長整型）變量更新賦值
            'Debug.Print VBA.TypeName(StatisticsAlgorithmModule)
            'Debug.Print VBA.TypeName(StatisticsAlgorithmModule.Public_Delay_length_input)
            'Debug.Print StatisticsAlgorithmModule.Public_Delay_length_input
    ...
    If Not (StatisticsAlgorithmControlPanel.Controls("Delay_random_input_TextBox") Is Nothing) Then
        ...
        Else
            ...
            '刷新載入的統計算法模塊中的變量值，統計算法模塊名稱值為：("StatisticsAlgorithmModule")
            StatisticsAlgorithmModule.Public_Delay_length_random_input = Public_Delay_length_random_input: Rem 為導入的爬蟲策略模塊 StatisticsAlgorithmModule 中包含的（人爲延時等待時長隨機波動範圍，單位為基礎值的百分比，單精度浮點型）變量更新賦值
            'StatisticsAlgorithmModule.Public_Delay_length_random_input = CSng(StatisticsAlgorithmControlPanel.Controls("Delay_random_input_TextBox").Text)
            'Debug.Print VBA.TypeName(StatisticsAlgorithmModule)
            'Debug.Print VBA.TypeName(StatisticsAlgorithmModule.Public_Delay_length_random_input)
            'Debug.Print StatisticsAlgorithmModule.Public_Delay_length_random_input
    ...
    '刷新載入的統計算法模塊中的變量值，統計算法模塊名稱值為：("StatisticsAlgorithmModule")
    StatisticsAlgorithmModule.Public_Delay_length = Public_Delay_length: Rem 為導入的爬蟲策略模塊 StatisticsAlgorithmModule 中包含的（經過隨機化之後的延時等待時長，長整型）變量更新賦值
    'Debug.Print VBA.TypeName(StatisticsAlgorithmModule)
    'Debug.Print VBA.TypeName(StatisticsAlgorithmModule.Public_Delay_length)
    'Debug.Print StatisticsAlgorithmModule.Public_Delay_length
...
Private Sub Interpolate_OptionButton_Click()
    '判斷單選框控件的選中狀態
    'If StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Interpolate_OptionButton").Value Then
    '    Public_Statistics_Algorithm_Name = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Interpolate_OptionButton").Caption): Rem 從單選框張提取值，結果為字符串型。函數 CStr() 表示轉換爲字符串類型。
    'End If
    'If StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Logistic_OptionButton").Value Then
    '    Public_Statistics_Algorithm_Name = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Logistic_OptionButton").Caption)
    'End If
    ...
    'End If
    'If StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("FisherDiscriminant_OptionButton").Value Then
    '    Public_Statistics_Algorithm_Name = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("FisherDiscriminant_OptionButton").Caption)
    'End If
    'If StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Meta_OptionButton").Value Then
    '    Public_Statistics_Algorithm_Name = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame").Controls("Meta_OptionButton").Caption)
    'End If
...
'用戶窗體運行後，鼠標左鍵單擊“Start calculate”命令按鈕，執行這段程序。調用子程序 “StatisticsAlgorithmModule.startCalculate(Public_Statistics_Algorithm_Name, Public_Data_Receptors, Public_Database_Server_Url, Public_Statistics_Algorithm_Server_Url, Public_Statistics_Algorithm_Server_Username, Public_Statistics_Algorithm_Server_Password, Public_Data_name_input_position, Public_Data_input_position, Public_Result_output_position)” 。
    ...
    '刷新載入的統計算法模塊中的變量值，統計算法模塊名稱值為：("StatisticsAlgorithmModule")
    StatisticsAlgorithmModule.PublicVariableStartORStopButtonClickState = PublicVariableStartORStopButtonClickState: Rem 為導入的統計算法模塊 StatisticsAlgorithmModule 中包含的（監測窗體中啓動運算按钮控件的點擊狀態，布爾型）變量更新賦值
    'Debug.Print VBA.TypeName(StatisticsAlgorithmModule)
    ...
    StatisticsAlgorithmControlPanel.Start_calculate_CommandButton.Enabled = False: Rem 禁用操作面板窗體 StatisticsAlgorithmControlPanel 中的按鈕控件 Start_calculate_CommandButton（啓動運算按鈕），False 表示禁用點擊，True 表示可以點擊
    StatisticsAlgorithmControlPanel.Database_Server_Url_TextBox.Enabled = False: Rem 禁用操作面板窗體 StatisticsAlgorithmControlPanel 中的文本輸入框控件 Database_Server_Url_TextBox（用於保存計算結果的數據庫服務器網址 URL 字符串輸入框），False 表示禁用點擊，True 表示可以點擊
    StatisticsAlgorithmControlPanel.Data_Receptors_CheckBox1.Enabled = False: Rem 禁用操作面板窗體 StatisticsAlgorithmControlPanel 中的多選框控件 Data_Receptors_CheckBox1（用於判斷辨識選擇計算結果保存類型 Database 的多選框），False 表示禁用點擊，True 表示可以點擊
    StatisticsAlgorithmControlPanel.Data_Receptors_CheckBox2.Enabled = False: Rem 禁用操作面板窗體 StatisticsAlgorithmControlPanel 中的多選框控件 Data_Receptors_CheckBox2（用於判斷辨識選擇計算結果保存類型 Excel 的多選框），False 表示禁用點擊，True 表示可以點擊
    StatisticsAlgorithmControlPanel.Statistics_Algorithm_Server_Url_TextBox.Enabled = False: Rem 禁用操作面板窗體 StatisticsAlgorithmControlPanel 中的文本輸入框控件 Statistics_Algorithm_Server_Url_TextBox（提供統計算法的服務器網址 URL 字符串輸入框），False 表示禁用點擊，True 表示可以點擊
    StatisticsAlgorithmControlPanel.Username_TextBox.Enabled = False: Rem 禁用操作面板窗體 StatisticsAlgorithmControlPanel 中的文本輸入框控件 Username_TextBox（用於驗證提供統計算法的服務器的賬戶名輸入框），False 表示禁用點擊，True 表示可以點擊
    StatisticsAlgorithmControlPanel.Password_TextBox.Enabled = False: Rem 禁用操作面板窗體 StatisticsAlgorithmControlPanel 中的按鈕控件 Password_TextBox（用於驗證提供統計算法的服務器的賬戶密碼輸入框），False 表示禁用點擊，True 表示可以點擊
    StatisticsAlgorithmControlPanel.Field_name_of_Data_Input_TextBox.Enabled = False: Rem 禁用操作面板窗體 StatisticsAlgorithmControlPanel 中的文本輸入框控件 Field_name_of_Data_Input_TextBox（保存原始數據字段命名 Excel 表格保存區間的輸入框），False 表示禁用點擊，True 表示可以點擊
    StatisticsAlgorithmControlPanel.Data_TextBox.Enabled = False: Rem 禁用操作面板窗體 StatisticsAlgorithmControlPanel 中的文本輸入框控件 Data_TextBox（保存原始數據的 Excel 表格保存區間的輸入框），False 表示禁用點擊，True 表示可以點擊
    StatisticsAlgorithmControlPanel.Output_position_TextBox.Enabled = False: Rem 禁用操作面板窗體 StatisticsAlgorithmControlPanel 中的文本輸入框控件 Output_position_TextBox（保存計算結果的 Excel 表格區間的輸入框），False 表示禁用點擊，True 表示可以點擊
    StatisticsAlgorithmControlPanel.FisherDiscriminant_OptionButton.Enabled = False: Rem 禁用操作面板窗體 StatisticsAlgorithmControlPanel 中的單選框控件 FisherDiscriminant_OptionButton（用於標識選擇某一個具體算法 FisherDiscriminant 的單選框），False 表示禁用點擊，True 表示可以點擊
    StatisticsAlgorithmControlPanel.Interpolate_OptionButton.Enabled = False: Rem 禁用操作面板窗體 StatisticsAlgorithmControlPanel 中的單選框控件 Interpolate_OptionButton（用於標識選擇某一個具體算法 Interpolate 的單選框），False 表示禁用點擊，True 表示可以點擊
    StatisticsAlgorithmControlPanel.Logistic_OptionButton.Enabled = False: Rem
    StatisticsAlgorithmControlPanel.Cox_OptionButton.Enabled = False: Rem
    StatisticsAlgorithmControlPanel.Polynomial3_OptionButton.Enabled = False: Rem
    StatisticsAlgorithmControlPanel.LC5p_OptionButton.Enabled = False: Rem
    StatisticsAlgorithmControlPanel.PCA_OptionButton.Enabled = False: Rem
    StatisticsAlgorithmControlPanel.Factor_OptionButton.Enabled = False: Rem
    StatisticsAlgorithmControlPanel.TimeSeries_OptionButton.Enabled = False: Rem
    StatisticsAlgorithmControlPanel.Meta_OptionButton.Enabled = False: Rem
    StatisticsAlgorithmControlPanel.Optimal_run_length_estimate_OptionButton.Enabled = False: Rem
    StatisticsAlgorithmControlPanel.Test_accuracy_estimate_OptionButton.Enabled = False: Rem
    StatisticsAlgorithmControlPanel.Test_power_estimate_OptionButton.Enabled = False: Rem
    StatisticsAlgorithmControlPanel.Statistical_sampling_OptionButton.Enabled = False: Rem
    ...
    '刷新載入的統計算法模塊中的變量值，統計算法模塊名稱值為：("StatisticsAlgorithmModule")
    StatisticsAlgorithmModule.Public_Database_Server_Url = Public_Database_Server_Url: Rem 為導入的統計算法模塊 StatisticsAlgorithmModule 中包含的（用於保存計算結果的數據庫服務器網址 URL 字符串）變量更新賦值
    'StatisticsAlgorithmModule.Public_Database_Server_Url = CStr(StatisticsAlgorithmControlPanel.Controls("Database_Server_Url_TextBox").Text)
    'StatisticsAlgorithmModule.Public_Database_Server_Url = CStr(StatisticsAlgorithmControlPanel.Controls("Database_Server_Url_TextBox").Value)
    'Debug.Print VBA.TypeName(StatisticsAlgorithmModule)
    'Debug.Print VBA.TypeName(StatisticsAlgorithmModule.Public_Database_Server_Url)
    'Debug.Print StatisticsAlgorithmModule.Public_Database_Server_Url
    ...
    If Not (StatisticsAlgorithmControlPanel.Controls("Data_Receptors_Frame") Is Nothing) Then
        ...
        '刷新載入的統計算法模塊中的變量值，統計算法模塊名稱值為：("StatisticsAlgorithmModule")
        StatisticsAlgorithmModule.Public_Data_Receptors = Public_Data_Receptors: Rem 為導入的爬蟲策略模塊 StatisticsAlgorithmModule 中包含的（用於存儲采集結果的容器類型複選框值，字符串變量）變量更新賦值
        'Debug.Print VBA.TypeName(StatisticsAlgorithmModule)
        'Debug.Print VBA.TypeName(StatisticsAlgorithmModule.Public_Data_Receptors)
        'Debug.Print StatisticsAlgorithmModule.Public_Data_Receptors
    ...
    '刷新載入的統計算法模塊中的變量值，統計算法模塊名稱值為：("StatisticsAlgorithmModule")
    StatisticsAlgorithmModule.Public_Statistics_Algorithm_Server_Url = Public_Statistics_Algorithm_Server_Url: Rem 為導入的統計算法模塊 StatisticsAlgorithmModule 中包含的（提供統計算法的服務器網址 URL 字符串）變量更新賦值
    'StatisticsAlgorithmModule.Public_Statistics_Algorithm_Server_Url = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Server_Url_TextBox").Text)
    'StatisticsAlgorithmModule.Public_Statistics_Algorithm_Server_Url = CStr(StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Server_Url_TextBox").Value)
    'Debug.Print VBA.TypeName(StatisticsAlgorithmModule)
    'Debug.Print VBA.TypeName(StatisticsAlgorithmModule.Public_Statistics_Algorithm_Server_Url)
    'Debug.Print StatisticsAlgorithmModule.Public_Statistics_Algorithm_Server_Url
    ...
    If Not (StatisticsAlgorithmControlPanel.Controls("Statistics_Algorithm_Frame") Is Nothing) Then
        ...
        '刷新載入的統計算法模塊中的變量值，統計算法模塊名稱值為：("StatisticsAlgorithmModule")
        StatisticsAlgorithmModule.Public_Statistics_Algorithm_Name = Public_Statistics_Algorithm_Name: Rem 為導入的統計算法模塊 StatisticsAlgorithmModule 中包含的（判別辨識選擇指定某一個具體的統計算法種類，字符串型變量）變量更新賦值
        'Debug.Print VBA.TypeName(StatisticsAlgorithmModule)
        'Debug.Print VBA.TypeName(StatisticsAlgorithmModule.Public_Statistics_Algorithm_Name)
        'Debug.Print StatisticsAlgorithmModule.Public_Statistics_Algorithm_Name
    ...
    End If
    StatisticsAlgorithmModule.Public_Statistics_Algorithm_Server_Username = Public_Statistics_Algorithm_Server_Username
    ...
    End If
    StatisticsAlgorithmModule.Public_Statistics_Algorithm_Server_Password = Public_Statistics_Algorithm_Server_Password

    '刷新保存原始數據字段命名 Excel 表格保存區間的字符串
    If Not (StatisticsAlgorithmControlPanel.Controls("Field_name_of_Data_Input_TextBox") Is Nothing) Then
        'Public_Data_name_input_position = CStr(StatisticsAlgorithmControlPanel.Controls("Field_name_of_Data_Input_TextBox").Value)
        Public_Data_name_input_position = CStr(StatisticsAlgorithmControlPanel.Controls("Field_name_of_Data_Input_TextBox").Text)
    End If
    StatisticsAlgorithmModule.Public_Data_name_input_position = Public_Data_name_input_position

    '刷新保存原始數據的 Excel 表格保存區間的字符串
    If Not (StatisticsAlgorithmControlPanel.Controls("Data_TextBox") Is Nothing) Then
        'Public_Data_input_position = CStr(StatisticsAlgorithmControlPanel.Controls("Data_TextBox").Value)
        Public_Data_input_position = CStr(StatisticsAlgorithmControlPanel.Controls("Data_TextBox").Text)
    End If
    StatisticsAlgorithmModule.Public_Data_input_position = Public_Data_input_position

    '刷新保存計算結果的 Excel 表格區間的字符串
    If Not (StatisticsAlgorithmControlPanel.Controls("Output_position_TextBox") Is Nothing) Then
        'Public_Result_output_position = CStr(StatisticsAlgorithmControlPanel.Controls("Output_position_TextBox").Value)
        Public_Result_output_position = CStr(StatisticsAlgorithmControlPanel.Controls("Output_position_TextBox").Text)
    End If
    StatisticsAlgorithmModule.Public_Result_output_position = Public_Result_output_position
    ...
    'If Not (StatisticsAlgorithmControlPanel.Controls("Inject_data_page_JavaScript_TextBox") Is Nothing) Then
    '    'Public_Inject_data_page_JavaScript_filePath = CStr(StatisticsAlgorithmControlPanel.Controls("Inject_data_page_JavaScript_TextBox").Value)
    '    Public_Inject_data_page_JavaScript_filePath = CStr(StatisticsAlgorithmControlPanel.Controls("Inject_data_page_JavaScript_TextBox").Text): Rem 從文本輸入框控件中提取值，結果為字符串類型。
    '    'Debug.Print Public_Inject_data_page_JavaScript_filePath
    'End If
    'If Public_Inject_data_page_JavaScript_filePath <> "" Then
    ...
    ''刷新載入的統計算法模塊中的變量值，統計算法模塊名稱值為：("StatisticsAlgorithmModule")
    'StatisticsAlgorithmModule.Public_Inject_data_page_JavaScript_filePath = Public_Inject_data_page_JavaScript_filePath: Rem 為導入的爬蟲策略模塊 StatisticsAlgorithmModule 中包含的（待插入目標數據源頁面的 JavaScript 脚本路徑全名）變量更新賦值
    ''StatisticsAlgorithmModule.Public_Inject_data_page_JavaScript_filePath = CStr(StatisticsAlgorithmControlPanel.Controls("Inject_data_page_JavaScript_TextBox").Text)
    ''Debug.Print VBA.TypeName(StatisticsAlgorithmModule)
    ''Debug.Print VBA.TypeName(StatisticsAlgorithmModule.Public_Inject_data_page_JavaScript_filePath)
    ''Debug.Print StatisticsAlgorithmModule.Public_Inject_data_page_JavaScript_filePath
    ...
    'StatisticsAlgorithmModule.Public_Inject_data_page_JavaScript = Public_Inject_data_page_JavaScript: Rem 為導入的爬蟲策略模塊 StatisticsAlgorithmModule 中包含的（待插入目標數據源頁面的 JavaScript 脚本字符串）變量更新賦值
    '''StatisticsAlgorithmModule.Public_Inject_data_page_JavaScript = CStr(StatisticsAlgorithmControlPanel.Controls("Inject_data_page_JavaScript_TextBox").Text)
    ''Debug.Print VBA.TypeName(StatisticsAlgorithmModule)
    ''Debug.Print VBA.TypeName(StatisticsAlgorithmModule.Public_Inject_data_page_JavaScript)
    ''Debug.Print StatisticsAlgorithmModule.Public_Inject_data_page_JavaScript
    ...
    'StatisticsAlgorithmControlPanel.Hide: Rem 隱藏用戶窗體



    '刷新控制面板窗體控件中包含的提示標簽顯示值
    If Not (StatisticsAlgorithmControlPanel.Controls("calculate_status_Label") Is Nothing) Then
        StatisticsAlgorithmControlPanel.Controls("calculate_status_Label").Caption = "假裝在等待的樣子 …": Rem 提示運算過程執行狀態，賦值給標簽控件 calculate_status_Label 的屬性值 .Caption 顯示。如果該控件位於操作面板窗體 StatisticsAlgorithmControlPanel 中，那麽可以用 .Controls() 方法獲取窗體中包含的全部子元素集合，並通過指定子元素名字符串的方式來獲取某一個指定的子元素，例如“StatisticsAlgorithmControlPanel.Controls("calculate_status_Label").Text”表示用戶窗體控件中的標簽子元素控件“calculate_status_Label”的“text”屬性值 calculate_status_Label.text。如果該控件位於工作表中，那麽可以使用 OleObjects 對象來表示工作表中包含的所有子元素控件集合，例如 Sheet1 工作表中有控件 CommandButton1，那麽可以這樣獲取：“Sheet1.OLEObjects("CommandButton" & i).Object.Caption 表示 CommandButton1.Caption”，注意 Object 不可省略。
    End If


    '調用運行導入的統計算法模塊 StatisticsAlgorithmModule 中包含的“Public Sub startCalculate(ByVal Statistics_Algorithm_Name As String, ByVal Data_Receptors As String, ByVal Database_Server_Url As String, ByVal Statistics_Algorithm_Server_Url As String, ByVal Statistics_Algorithm_Server_Username As String, ByVal Statistics_Algorithm_Server_Password As String, ByVal Data_name_input_position As String, ByVal Data_input_position As String, ByVal Result_output_position As String, ParamArray OtherArgs())”子過程/函數，啓動運算。Private 關鍵字表示子過程只在本模塊中有效，public 關鍵字表示子過程在所有模塊中都有效
    Call StatisticsAlgorithmModule.startCalculate(Public_Statistics_Algorithm_Name, Public_Data_Receptors, Public_Database_Server_Url, Public_Statistics_Algorithm_Server_Url, Public_Statistics_Algorithm_Server_Username, Public_Statistics_Algorithm_Server_Password, Public_Data_name_input_position, Public_Data_input_position, Public_Result_output_position): Rem
    'ThisWorkbook.VBProject.VBComponents("StatisticsAlgorithmModule").Controls("startCalculate")
    ...
    ''刷新控制面板窗體控件中包含的提示標簽顯示值
    'If Not (StatisticsAlgorithmControlPanel.Controls("calculate_status_Label") Is Nothing) Then
    '    StatisticsAlgorithmControlPanel.Controls("calculate_status_Label").Caption = "Calculation completed.": Rem 提示運算過程執行狀態，賦值給標簽控件 calculate_status_Label 的屬性值 .Caption 顯示。如果該控件位於操作面板窗體 StatisticsAlgorithmControlPanel 中，那麽可以用 .Controls() 方法獲取窗體中包含的全部子元素集合，並通過指定子元素名字符串的方式來獲取某一個指定的子元素，例如“StatisticsAlgorithmControlPanel.Controls("calculate_status_Label").Text”表示用戶窗體控件中的標簽子元素控件“calculate_status_Label”的“text”屬性值 calculate_status_Label.text。如果該控件位於工作表中，那麽可以使用 OleObjects 對象來表示工作表中包含的所有子元素控件集合，例如 Sheet1 工作表中有控件 CommandButton1，那麽可以這樣獲取：“Sheet1.OLEObjects("CommandButton" & i).Object.Caption 表示 CommandButton1.Caption”，注意 Object 不可省略。
    'End If
