    ...
    if request_Path == "/":
        ...
        if len(stdout_Command) > 0:
            if stdout_Command.find("\n", 0, int(len(stdout_Command)-1)) != -1:
                for x in stdout_Command.split("\n", -1):
                    # print(x + '\n', end='')
                    backArray.append(x)
            else:
                backArray.append(stdout_Command)
        # print(backArray)
        ...
        #             "date_transaction" : [datetime.date("2019-01-02"), datetime.date("2019-01-03"), datetime.date("2019-01-04"), ...],
        #             "turnover_volume" : [int(355900000), int(356100000), int(354800000), ...],
        #             "turnover_rate" : [float(0.0321), float(0.0432), float(0.0533), ...],
        #             "turnover_amount" : [float(0.0321), float(0.0432), float(0.0533), ...],
        #             "opening_price" : [float(4.56), float(5.68), float(3.56), ...],
        #             "close_price" : [float(3.56), float(6.68), float(2.56), ...],
        #             "high_price" : [float(5.56), float(7.68), float(5.56), ...],
        #             "low_price" : [float(2.56), float(4.68), float(1.56), ...],
        #             "focus" : [float(), float(), float(), ...],
        #             "amplitude" : [float(), float(), float(), ...],
        #             "amplitude_rate" : [float(), float(), float(), ...],
        #             "opening_price_Standardization" : [float(), float(), float(), ...],
        #             "closing_price_Standardization" : [float(), float(), float(), ...],
        #             "high_price_Standardization" : [float(), float(), float(), ...],
        #             "low_price_Standardization" : [float(), float(), float(), ...],
        #             "book_value_per_share" : [float(), float(), float(), ...],
        #             "price_earnings" : [float(), float(), float(), ...],
        #             "turnover_volume_growth_rate" : [float(), float(), float(), ...],
        #             "opening_price_growth_rate" : [float(), float(), float(), ...],
        #             "closing_price_growth_rate" : [float(), float(), float(), ...],
        #             "high_price_proportion" : [float(), float(), float(), ...],
        #             "low_price_proportion" : [float(), float(), float(), ...],
        #             "closing_minus_opening_price_growth_rate" : [float(), float(), float(), ...],
        #             "sum_2_turnover_volume_growth_rate" : [float(), float(), float(), ...],
        #             "sum_2_opening_price_growth_rate" : [float(), float(), float(), ...],
        #             "sum_2_closing_price_growth_rate" : [float(), float(), float(), ...],
        #             "sum_2_high_price_proportion" : [float(), float(), float(), ...],
        #             "sum_2_low_price_proportion" : [float(), float(), float(), ...],
        #             "sum_2_closing_minus_opening_price_growth_rate" : [float(), float(), float(), ...],
        #             "sum_2_KLine_Intuitive_Momentum" : [float(), float(), float(), ...],
        #             "sum_3_turnover_volume_growth_rate" : [float(), float(), float(), ...],
        #             "sum_3_opening_price_growth_rate" : [float(), float(), float(), ...],
        #             "sum_3_closing_price_growth_rate" : [float(), float(), float(), ...],
        #             "sum_3_high_price_proportion" : [float(), float(), float(), ...],
        #             "sum_3_low_price_proportion" : [float(), float(), float(), ...],
        #             "sum_3_closing_minus_opening_price_growth_rate" : [float(), float(), float(), ...],
        #             "sum_3_KLine_Intuitive_Momentum" : [float(), float(), float(), ...],
        #             "sum_5_turnover_volume_growth_rate" : [float(), float(), float(), ...],
        #             "sum_5_opening_price_growth_rate" : [float(), float(), float(), ...],
        #             "sum_5_closing_price_growth_rate" : [float(), float(), float(), ...],
        #             "sum_5_high_price_proportion" : [float(), float(), float(), ...],
        #             "sum_5_low_price_proportion" : [float(), float(), float(), ...],
        #             "sum_5_closing_minus_opening_price_growth_rate" : [float(), float(), float(), ...],
        #             "sum_5_KLine_Intuitive_Momentum" : [float(), float(), float(), ...],
        ...
        #             "average_5_closing_price" : [float(), float(), float(), ...],
        #             "average_10_closing_price" : [float(), float(), float(), ...],
        ...
        if is_Optimize == False:
            ...
            response_data_Dict["return_PickStock"]["Coefficient"] = PickStock_Pdata_0
            ...
            return_PickStock = PickStock(
                ...
                Pdata_0 = PickStock_Pdata_0,  # [int(3), int(5)],  # training_data["002611"]["Pdata_0"],
                # weight = PickStock_weight,  # []  # training_data["002611"]["weight"],
                Plower = PickStock_Plower,  # [-math.inf, -math.inf],  # training_data["002611"]["Plower"],
                Pupper = PickStock_Pupper,  # [+math.inf, +math.inf],  # training_data["002611"]["Pupper"],
            ...
            response_data_Dict["return_PickStock"]["Coefficient"] = return_PickStock["Coefficient"]
